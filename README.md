...
Olá, este é um dos projetos do modulo de BackEnd da TRYBE, consiste em desenvolver um webchat utilizando a camada de view, para renderizar as páginas html, e 
